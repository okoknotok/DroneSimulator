...
await loadScript('/js/mission-solutions.js');
await loadScript('/js/flight-simulator.js');
await loadScript('/js/battle-cpu-coder.js');
await loadScript('/js/battle-mode.js');
await loadScript('/js/start-menu.js');
await loadScript('/js/mission-mode.js');
await loadScript('/js/builder-mode.js');
